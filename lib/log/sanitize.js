...
function _maskEnvValues(s) {
  ...
  // Replace any exact environment variable values with a placeholder that shows key presence only
  // Sort keys by length desc so longer values are replaced first to avoid partial collisions.
